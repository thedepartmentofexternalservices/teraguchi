...
Updated 2026-09-16. Current milestone: one reproducible, integrated Mac
...
Alan's Quit question is clarified in the PR description: the bridge handles a
Qt Quit event and adds no Command-Q binding, but it cannot distinguish a menu
Quit event from one generated by a shortcut. Native Command-Q behavior during a
session has not been demonstrated. Do not claim this is a menu-only fix.
