...
# Run shared topology, toolbar geometry, recovery, and clipboard lifecycle
# tests on every Mac Client candidate.
for suite in outputtopology planktoolbarlogic desktopstage macclipboardsync; do
