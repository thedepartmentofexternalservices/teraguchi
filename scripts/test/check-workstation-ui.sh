...
scenarios = ('settings', 'support-displays', 'support-tablet', 'support-access', 'support-report', 'studio-needed', 'studio-ready', 'studio-expired', 'permission-panel-needed', 'permission-setup-needed', 'permission-setup-allowed', 'assignment-stale', 'assignment-refreshing', 'assignment-failure', 'ready', 'offline', 'occupied', 'incompatible', 'empty', 'connected',
...
for appearance, compact, states in (('light', False, scenarios), ('light', True, ('settings', 'support-displays', 'support-report', 'studio-expired', 'permission-panel-needed', 'permission-setup-needed', 'ready', 'display-mismatch', 'interrupted', 'power-off', 'power-unknown', 'power-starting')), ('dark', False, ('settings', 'support-report', 'permission-setup-allowed', 'ready', 'power-off', 'interrupted')), ('dark', True, ('power-unknown',))):
    for state in states:
